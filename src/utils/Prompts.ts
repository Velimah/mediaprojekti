export type PromptTemplate =
 ...
 Create a fully functional navigation section <nav></nav> with 4 links named ${linkNames}. make href for links using <a href="#section">Hero</a> <a href="#main">Main</a> <a href="#table">Table</a> <a href="#footer">Footer</a>
