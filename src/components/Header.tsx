...
const Header = () => {
  ...
  const NavigationItems = () => {
    return (
            <>
            <li className="flex">
              <button onClick={() => setActivePage('Build')} className={`flex items-center ${activePage === 'Build' ? 'active' : 'font-normal'}`}>
    ...
    return (
      <nav id="navigation" className="font-bold bg-ai-black-100 md:m-5 p-4 h-12 w-max-screen md:rounded-md flex items-center justify-between">
        <Link to="/" onClick={() => setActivePage('')} className="text-ai-primary flex items-center text-2xl font-robot">
