...
const Header = () => {
  ...
  return (
    <nav
      id='navigation'
      className='font-bold bg-gray-200 md:m-5 p-4 h-12 w-max-screen rounded-md flex items-center justify-between'
    >
      <Link to='/' className='flex items-center text-sm md:text-2xl'>
