      ...
      >
        <div
          className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[1] w-full md:w-[35rem] h-auto bg-ai-black-100 rounded-lg shadow-lg ${
            handleCloseSave ? "animate-alert-pop-off scale-0" : "animate-alert-pop-up"
          }`}
          onAnimationEnd={() => {
            if (handleCloseSave) {
              setOpenSave(false);
          ...
          <div className='my-4'>
            <div className='bg-ai-black-100 flex flex-col items-center border border-ai-black-100 rounded'>
              ...
              <div className='py-4 md:space-x-2 flex flex-wrap justify-center gap-2'>
                <button onClick={handleUndo} className='toolbar-btn w-40 md:w-auto'>
                ...
                <button onClick={handleCopy} className='toolbar-btn w-40 md:w-auto'>
                  <span className='flex justify-center gap-2'>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='currentColor' className='w-6 h-6'>
                      <path
                        fillRule='evenodd'
                ...
                <button onClick={handleBuild} className='build-btn toolbar-btn w-40'>
                  <span className='flex justify-center gap-2'>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='currentColor' className='w-6 h-6'>
                      <path
                        fillRule='evenodd'
                ...
                <button onClick={() => setOpenSave(true)} className='build-btn toolbar-btn w-40'>
                  <span className='flex justify-center gap-2'>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='currentColor' className='w-6 h-6'>
                      <path
                        fillRule='evenodd'
