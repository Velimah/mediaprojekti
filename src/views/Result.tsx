  ...
  const SavePopup = () => {
    return (
      <div className="w-full h-full overflow-hidden absolute top-1/2 left-1/2 transform translate-x-[-50%] -translate-y-1/2 z-[1] bg-black bg-opacity-25" id="alertDialog">
        <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[1] w-full md:w-[35rem] h-auto bg-ai-black-100 rounded-lg shadow-lg ${handleCloseSave ? 'animate-alert-pop-off scale-0' : 'animate-alert-pop-up'}`}
            onAnimationEnd={() => {
              if(handleCloseSave){
                setOpenSave(false);
          ...
          <div className={`text-ai-primary hover:text-ai-secondary cursor-pointer absolute right-0 pr-4 pt-4`}
      ...
      <div className="w-full lg:w-3/4 px-4">
        <div className="my-4">
          <div className="bg-ai-black-100 flex flex-col items-center border border-ai-black-100 rounded">
            <h2 className="bg-ai-secondary text-ai-black text-lg font-bold font-robot w-full p-3 h-12 flex items-center uppercase cursor-pointer" onClick={toggleCodeVisibility}>
              {codeVisible ? (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 pr-1 toggled hamburger_icon">
        ...
        <div className="mb-4">
          <div className="bg-white flex flex-col items-center border border-black rounded">
            <h2 className="bg-ai-primary text-ai-black text-lg font-bold font-robot w-full p-3 h-12 flex items-center uppercase cursor-pointer" onClick={togglePreviewVisibility}>
            {previewVisible ? (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 pr-1">
                  <path fillRule="evenodd" d="M11.47 2.47a.75.75 0 011.06 0l7.5 7.5a.75.75 0 11-1.06 1.06l-6.22-6.22V21a.75.75 0 01-1.5 0V4.81l-6.22 6.22a.75.75 0 11-1.06-1.06l7.5-7.5z" clipRule="evenodd" />
                </svg>              
          ...
          {previewVisible && (
            <div id="resizePreview" className="pt-1 w-full flex flex-row-reverse gap-2">
              <button className="rounded-md p-1 bg-white text-ai-black border-2 border-transparent border-ai-primary font-bold cursor-pointer transition duration-300 ease-in-out hover:bg-ai-secondary"
              ...
              <button className="rounded-md p-1 bg-white text-ai-black border-2 border-transparent border-ai-primary font-bold cursor-pointer transition duration-300 ease-in-out hover:bg-ai-secondary"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10 h-1+">
