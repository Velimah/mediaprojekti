...
const Account: React.FC = () => {
  const { getUsersSavedWebsites, deleteUsersSavedWebsite } = useUsers();
  const { user } = useUser();
                ...
                <div className="m-2 relative">
                  ...
                  <div className="w-full">
                    <button
                      ...
                      className="bg-red-500 m-2 absolute top-0 left-0 hover:bg-red-700 rounded-full border-gray-300 border p-1 font-bold arrow-path"
                    >
                      <svg
